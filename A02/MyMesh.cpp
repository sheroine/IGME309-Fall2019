...
void MyMesh::GenerateCone(float a_fRadius, float a_fHeight, int a_nSubdivisions, vector3 a_v3Color)
{
	...
	{
		AddQuad(vector3(0, 0, 0),
			vector3(a_fRadius * cos(angle * i), 0, a_fRadius * sin(angle * i)),
			vector3(a_fRadius * cos(angle * (i + 1)), 0, a_fRadius * sin(angle * (i + 1))),
			vector3(0, a_fHeight, 0));
	}
...
void MyMesh::GenerateCylinder(float a_fRadius, float a_fHeight, int a_nSubdivisions, vector3 a_v3Color)
{
	...
	for (int i = 0; i < a_nSubdivisions; i++)
	{
		vector3 bottomPt1(a_fRadius * cos(angle * i), a_fRadius * sin(angle * i), 0);
		vector3 bottomPt2(a_fRadius * cos(angle * (i + 1)), a_fRadius * sin(angle * (i + 1)), 0);
		vector3 topPt1(a_fRadius * cos(angle * i), a_fRadius * sin(angle * i), a_fHeight);
		...
		//lateral faces
		AddQuad(bottomPt1, bottomPt2, topPt1, topPt2);
	}
